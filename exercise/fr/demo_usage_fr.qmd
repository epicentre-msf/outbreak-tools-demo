...
::: {.callout-note title="Aide au remplissage"}
...
Cliquez sur la cellule `$C$2` où est écrit `Aller à la section`, puis sélectionnez la section `Caractéristiques de l'âge des patients`.
...
Dans quelle semaine épidémiologique a-t-on eu plus de patients décédés?
...
cet export qui est envoyé au dashboard. Il ne faut pas renommer le fichier exporté. Vous pouvez l'ouvrir pour explorer les données et regarder
...
Ajouter les données du fichier à celles déjà présentes dans la linelist.
